...
$tableName = "Workspace_Datasets"
$datalakeFolder = "Workspace_Datasets"
...
$LASTAPIPARAM = '/datasets' #Parameter needed to retrieve all datasets in a workspace
$folderPath = "C:\Users\bvadmin\WorkspacesforDatasets_$currenttimestamp.csv" #Path on VM to save results to
...
$allinfo | foreach-Object { $_.value} | Select-Object *, @{l="workspaceid";e={$Id.Id}} | Export-Csv $Fullpath -Append
}
catch
{ Write-Log -Message $_.Exception.Message -Type ($_.Exception.GetType().FullName) }

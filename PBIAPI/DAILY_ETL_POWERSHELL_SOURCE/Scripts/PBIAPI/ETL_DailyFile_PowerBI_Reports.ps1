...
$tableName = "DatasetReports"
$datalakeFolder = "Dataset_Reports"
$dailyDateofData = (get-date).ToString("yyyMMdd") | foreach {$_ -replace ":", "."}
$Global:Logfilepath = ComputeNewValue $tableName
$URL = 'https://api.powerbi.com/v1.0/myorg/admin/reports' #URL to get necessary information
...
Try {
Write-Log -Message 'USING PBIREST API https://api.powerbi.com/v1.0/myorg/admin/reports GET' -Type "Script_CommandStart"
...
Write-Log -Message 'USING PBIREST API https://api.powerbi.com/v1.0/myorg/admin/reports GET' -Type "CommandEnd"

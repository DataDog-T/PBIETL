...
$URL = 'https://api.powerbi.com/v1.0/myorg/admin/dashboards' #URL to get necessary information
...
Try {
Write-Log -Message 'Using PBIRESTAPI https://api.powerbi.com/v1.0/myorg/admin/dashboards GET' -Type "Script_CommandStart"
...
Write-Log -Message 'Using PBIRESTAPI https://api.powerbi.com/v1.0/myorg/admin/dashboards GET' -Type "CommandEnd"

...
$tableName = "Workspace_Reports"
$datalakeFolder = "Workspace_Reports"
...
$folderPath = "C:\Users\bvadmin\PBIAPI\Workspacesforreports_$currenttimestamp.csv" #Path on VM to save results to
$LASTAPIPARAM = '/reports'
...
$MAINURL  = 'https://api.powerbi.com/v1.0/myorg/admin/groups/' + $Id.Id + $LASTAPIPARAM #Retrieving ID from first CSV file
